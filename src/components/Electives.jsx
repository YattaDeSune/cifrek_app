...
import {ReactComponent as ElectivesIcon} from '../assets/images/Electives.svg'
...
const Electives = () => {
    ...
    const handleNavigateToSchedule = () => navigate('/schedule')
        ...
        <div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.tabMenu}>
                    ...
                    <div onClick={handleNavigateToSchedule} className={styles.tabElement}><ElectivesIcon /> Факультативы </div>
